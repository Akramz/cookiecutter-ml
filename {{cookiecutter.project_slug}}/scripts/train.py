...
from {{cookiecutter.project_slug}}.config import TrainerConfig
from {{cookiecutter.project_slug}}.models import get_model
from {{cookiecutter.project_slug}}.datamodules import get_datamodule
